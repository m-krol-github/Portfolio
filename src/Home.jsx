...
import MatrixRain from './MatrixRain'; // Zakładam, że masz już ten komponent

// Podmień te ścieżki na swoje zrzuty ekranu
import gameImg from './assets/thumbnails/winter-tire.png';
import cesiumImg from './assets/thumbnails/map-thumbnail.jpg';
import stripImg from './assets/thumbnails/data-mapping.jpg';
  ...
  return (
    <div style={{ 
      ...
      <main style={{ flex: 1, display: 'flex', position: 'relative', overflow: 'hidden' }}>
        ...
        <div style={{ 
          flex: 1, position: 'relative', overflow: 'hidden', borderRight: '1px solid #222' 
        }}>
          {/* Tło z gry */}
          <div style={{ 
            position: 'absolute', width: '100%', height: '100%', 
            backgroundImage: `url(${gameImg})`, backgroundSize: 'cover', backgroundPosition: 'center',
          ...
          <div style={{
            ...
            transform: 'rotate(-35deg)', // Rotacja w lewo
            transformOrigin: 'top left', // Zakotwiczenie w lewym górnym rogu
            zIndex: 5,
        ...
        <div style={{ 
          ...
          <div style={{ 
            position: 'absolute', width: '100%', height: '100%', 
            backgroundImage: `url(${cesiumImg})`, backgroundSize: 'cover', backgroundPosition: 'center',
            filter: 'brightness(0.6)' 
          }} />
